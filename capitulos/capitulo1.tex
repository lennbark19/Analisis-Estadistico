...
5. \textbf{Baltazar Alcaraz, K. (2024). Revisión sistemática del uso de tecnologías inteligentes enfocadas en los procesos de las industrias sostenibles. Centro Nacional de Investigación y Desarrollo Tecnológico (CENIDET), Tecnológico Nacional de México.}
...
\newpage
6. \textbf{Quiguanas Chila, B. y Arias Bocanegra, D. L. (2024). Herramienta de monitoreo y análisis: Dashboard interactivo del desempeño académico de los estudiantes de Ciencia Política en la UNAD. Escuela de Ciencias Básicas, Tecnología e Ingeniería, Universidad Nacional Abierta y a Distancia (UNAD).}
...
\newpage
7. \textbf{Pérez Paucar, L. O. (2019). Análisis de información utilizando un dashboard para la toma de decisiones en la Coordinación Zonal 1 – Educación. Facultad de Sistemas Mercantiles, Universidad Regional Autónoma de los Andes (UNIANDES).}

En este trabajo de titulación de maestría se analiza el reto operativo que enfrentaba la Coordinación Zonal 1 del Ministerio de Educación del Ecuador, donde la gestión y el seguimiento de la ejecución presupuestaria y de la información docente e institucional se realizaban mediante hojas de cálculo manuales en Excel. Este esquema tradicional generaba cuellos de botella, lentitud en la elaboración de reportes ejecutivos, inconsistencias en los datos e incertidumbre administrativa en la toma de decisiones gerenciales.
La metodología adoptada combinó enfoques cualitativos y cuantitativos a través de encuestas aplicadas al personal directivo y analistas técnicos. Para el diseño e implementación del almacén de datos, se utilizó la metodología Hefesto, estructurando las etapas de análisis de requerimientos, modelado dimensional y procesos de extracción, transformación y carga (ETL) a partir de los registros del sistema financiero eSIGEF. La visualización de la información se desarrolló sobre la plataforma analítica de código abierto Knowage.
El tablero de control desarrollado integró dimensiones analíticas por Entidad Operativa Desconcentrada (EOD), grupos de gasto, actividades, programas y temporalidad mensual. La implementación del dashboard permitió detectar de forma inmediata alertas críticas, tales como una ejecución presupuestaria de solo el 19.92\% en la sede Zonal en comparación con otros distritos operativos. Asimismo, facilitó la consulta comparativa de la distribución de docentes por tipo de contrato y la caracterización de instituciones educativas por sostenimiento y tipología. La investigación demostró que la sustitución de herramientas estáticas por tableros de Business Intelligence optimiza sustancialmente los tiempos de respuesta y fortalece el cumplimiento de los objetivos de Gobierno por Resultados (GPR).

\newpage
8. \textbf{Pincay Ponce, F. B., Baque Pinargote, O. S., Caicedo Plúa, C. R. y Paladines Morán, J. P. (2024). Dashboard para el control y seguimiento académico de los estudiantes en la educación superior. Revista Científica de Innovación Educativa y Sociedad Actual "ALCON", Vol. 4, Núm. 5.}
