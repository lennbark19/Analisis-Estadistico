...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{imagenes/Manual tecnico.jpeg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{imagenes/Manual de usuario.jpeg}
    \caption{Manual de Usuario}
    \label{fig:manualuser}
\end{figure}
\newpage
